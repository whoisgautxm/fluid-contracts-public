...
///         Intended users are thus allow-listed protocols, e.g. the Lending protocol (iTokens), Vault protocol etc.
        ...
        if (supplyAmount_ != 0) {
            // execute supply or withdraw and update total amounts
            {
                ...
                if (newSupplyInterestFree_ == 0) {
                    ...
                    // Note check for revert UserModule__ValueOverflow__TOTAL_SUPPLY is further down when we anyway
