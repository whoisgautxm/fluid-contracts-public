...
import { ILiquidityResolver } from "../liquidity/iLiquidityResolver.sol";
import { IVaultFactory } from "../../../protocols/vault/interfaces/iVaultFactory.sol";
...
contract Variables {
    ...
    constructor(address factory_, address liquidity_, address liquidityResolver_) {
        ...
        LIQUIDITY_RESOLVER = ILiquidityResolver(liquidityResolver_);
    }
}
